...
<body>
	...
	<div class="homeclass">
		<span id="hm">New Peer Configuration</span>
	</div>
	<div class="sidebar">
		<ul class="demo_ul">
			...
			<li id="has-sub" class="demo_li"><a id="plan" class="hrefa"
				href="./plan"><i id="icon_fa" class="fa fa-file-text"></i>Counter Data</a></li>
...
<div class="col-sm-3"></div>
       ...
       <table class="table table-striped">
			...
			<td><form:input id="host_name" name="host_name" path="host_name"
				required="required" class="form-control" /></td>
			</tr>

			<tr><td><span class="RC">Address</span></td>
			<td><form:select path="address" name="address" class="form-control">
			...
			<td><form:input path="port" name="port" required="required" class="form-control" /></td>
		</tr>

			<tr><td><span class="RC">Protocol</span></td>
			<td><form:select path="protocol" name="protocol" class="form-control">
				<option value="" style="display: none" disabled selected>Select</option>
			...
			<tr><td><span class="RC"> Watch Dog Timeout</span></td>
			<td><form:input path="watch_timeout" required="required"
				name="watch_timeout" class="form-control" /></td>
			</tr>
			<tr>
			<td colspan="2"><input class="submitPeer" type="Submit" value="Submit" class="form-control"/></td>
			</tr>
			</table>
		</form:form>
