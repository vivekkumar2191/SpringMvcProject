...
<div class="col-sm-3"></div>
		...
		<form:form method="POST" class="route_form2" name="route_form2"
			action="../editsavesample" modelAttribute="Sample">
			<table class="table table-striped" >
			<c:forEach var="Sample" items="${list}">
				<tr><td><span class="RC">Realm</span></td>
				<td><form:input path="realm" name="realm" value="${Sample.realm}" class="form-control"></form:input></td>
				</tr>

				<tr><td><span class="RC">Destination Host Name</span></td>
				<td><form:input name="dest_host" path="dest_host"
					value="${Sample.dest_host}" class="form-control"></form:input></td>
				</tr>
				<tr>
				<td colspan="2">
				<form:hidden path="Realm" name="id" value="${Sample.realm}" class="form-control" />
               </td>
			</tr>
			</c:forEach>
			<tr>
