...
<body>
	...
	<div class="title1">
		<label class="admin_label7"><span id="tag">NAF Provisioning
	...
	<div class="homeclass">
		<span id="hm">Modify NAF Provisioning Configuration</span>
	</div>
	<div class="sidebar">
		<ul class="demo_ul">
	...
	<div class="ct">
		<div class="seconddiv">
			<span class="namename">NAF PROVISIONING CONFIGURATION</span>
		</div>
		...
		<form:form method="post" class="peerform" name="peerform"
			action=".././editsavenaf" modelAttribute="Naf">
			<table class="table table-striped" >
				<c:forEach var="Naf" items="${list}">
				<tr><td><span class="RC">Domain Name</span></td>
				<td><form:input path="domain_name" value="${Naf.domain_name}" class="form-control" ></form:input></td>
				</tr>	
			<tr><td><span class="RC">Ua Security ProtocolId</span></td>
				<td><form:input path="ua_security_protocol_id" value="${Naf.ua_security_protocol_id}" class="form-control"></form:input></td>
			</tr>
				<tr><td><span class="RC">IMPI Send Flag</span></td>
				<td><form:input path="impi_send_flag" value="${Naf.impi_send_flag}" class="form-control"></form:input></td>
				
				</tr>
				<tr>					
				<td><span class="RC">IP Address</span></td>
				<td><form:input path="ip_address" value="${Naf.ip_address}" class="form-control"></form:input></td>
				</tr>
				
			<tr><td colspan="2"><form:hidden path="Domain_name" name="id" value="${Naf.domain_name}" class="form-control"/></td></tr>
			</c:forEach>
