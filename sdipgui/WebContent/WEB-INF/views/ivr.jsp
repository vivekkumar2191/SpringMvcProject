...
<body>
	...
	<div class="title1">
		<label class="admin_label7"><span id="tag">IVR</span></label>
	...
	<div class="ct">
		...
		<div class="t1">
			...
			</select> <label class="noti_lbl8">Voice</label>
			<div class="noti_div1">
			...
			<label class="noti_lbl9">System Voice</label>
			<div class="noti_div2">
		...
		<table class="customers1" id="customers1">
			...
			<tbody>
				...
				<c:forEach var="ntfList" items="${ntfList}">
					<tr>
						<td>${ntfList.orderid}</td>
						<td>${ntfList.typesdesc}</td>
						<td>${ntfList.fieldid}</td>
						<c:if test="${ntfList.fieldtypeid==1}">
							<td>${ntfList.shortdesc}</td>
						</c:if>
						<td></td>
						<td></td>
						<c:if test="${ntfList.fieldtypeid==2}">
							<td>${ntfList.shortdesc}</td>
						</c:if>
						<td><a class="deleteIvr"
							href="<c:url value="/deletefieldid/${ntfList.fieldid}" />">Delete</a></td>
					</tr>
				</c:forEach>
			</tbody>
		...
		<button class="postData" value="/ntf">Save</button>
...
$(".postData").on("click", function(e){
	...
	$.ajax({
        url: 'http://localhost:8080/NotificationEditor/ntf',
        type: 'POST',
